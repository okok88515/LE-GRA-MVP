...
runtime_output="$workspace/p3_6i2_coupled_output"
repo_output="$script_dir/p3_6i2_coupled_output"
runtime_scenario="$workspace/p3_6i2_runtime_scenario"
...
cp "$script_dir/p3_6i2_coupled_scenario/targeted_family_conservative.launchd.xml" "$runtime_scenario/targeted_family_conservative.launchd.xml"
cp "$script_dir/p3_6i2_coupled_scenario/targeted_family_conservative.sumocfg" "$runtime_scenario/targeted_family_conservative.sumocfg"
cp "$script_dir/p3_6i2_coupled_scenario/targeted_family_conservative.rou.xml" "$runtime_scenario/targeted_family_conservative.rou.xml"
cp "$script_dir/p3_6i2_coupled_scenario/omnetpp.ini" "$runtime_scenario/omnetpp.ini"

opp_env run --workspace "$workspace" \
  simu5g-1.4.3 veins-5.3.1 inet-4.6.0 omnetpp-6.3.0 \
  --no-isolated -c '
    set -euo pipefail
    output=/home/opp_env/p3_5_workspace/p3_6i2_coupled_output
    scenario=/home/opp_env/p3_5_workspace/p3_6i2_runtime_scenario
    ...
    opp_run -u Cmdenv -f "$scenario/omnetpp.ini" -c P3_6I2_TargetedFamily_DL \
    ...
    echo P3_6I2_COUPLED_SIMULATION_OK
  '
...
echo P3_6I2_COUPLED_OUTPUT_COPIED
